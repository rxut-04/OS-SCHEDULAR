          ...
          <div className="max-w-4xl mx-auto">
            <div className="mb-8 sm:mb-12 rounded-2xl overflow-hidden border border-white/10 bg-black/40 backdrop-blur-xl">
              ...
              <div className="flex items-center gap-3 px-5 py-4 border-b border-white/10 bg-white/5">
                <div className="w-9 h-9 rounded-xl flex items-center justify-center shrink-0 bg-purple-600">
                  <svg className="w-5 h-5 text-white" fill="currentColor" viewBox="0 0 24 24">
                    <path d="M8 5v14l11-7z" />
                  </svg>
                </div>
                <div>
                  <p className="font-black text-sm sm:text-base leading-tight text-purple-400">
                    Algorithm Explainer Video
                  </p>
                  <p className="text-xs mt-0.5 text-neutral-400">
                    Watch how K-Nearest Neighbors works — then try the interactive visualiser below
                  </p>
                </div>
              </div>
              ...
              <div className="relative w-full bg-black" style={{ aspectRatio: "16/9" }}>
                <video
                  ...
                  style={{ display: "block" }}
                >
                  <source src="/VIDEOS/K-Nearest-Neighbor.mp4" type="video/mp4" />
              ...
              <div className="px-5 py-3 flex items-center justify-between border-t border-white/10">
                <p className="text-xs text-neutral-400">
                  Covers Distance Calculation · K Selection · Majority Voting · Classification
                </p>
