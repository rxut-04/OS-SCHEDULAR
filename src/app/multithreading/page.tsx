  ...
  return (
    <div className="min-h-screen bg-[#0B0F14] text-white">
      ...
      <div className="relative z-10 p-4 lg:p-6">
        ...
        {/* ── Multithreading Models Explainer Video ─────────────── */}
        <div className="mb-8 rounded-2xl overflow-hidden border" style={{ borderColor: "var(--border-color)", background: "var(--alg-white)" }}>
          {/* Header */}
          <div className="flex items-center gap-3 px-5 py-4 border-b" style={{ borderColor: "var(--border-color)", background: "var(--alg-mint)" }}>
            ...
            <div>
              ...
              <p className="text-xs mt-0.5" style={{ color: "var(--text-secondary)" }}>
                Watch how Multithreading Models work — then explore the interactive visualiser below
              </p>
            </div>
          </div>
          {/* Player */}
          <div className="relative w-full bg-black" style={{ aspectRatio: "16/9" }}>
            <video className="w-full h-full" controls preload="metadata" style={{ display: "block" }}>
          ...
          <div className="px-5 py-3 flex items-center gap-2" style={{ background: "var(--alg-bg)" }}>
            ...
            <p className="text-xs" style={{ color: "var(--text-secondary)" }}>
              Covers Many-to-One · One-to-One · Many-to-Many · User vs Kernel Threads · Thread Libraries.
            </p>
          </div>
        </div>
